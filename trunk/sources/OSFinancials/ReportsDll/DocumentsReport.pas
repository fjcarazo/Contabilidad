...
Uses
  ...
  PrePrinted, TcVariables, DatabaseAccess, XRoutines;
...
begin
    ...
    begin
      qrlUnit.Caption := '';
      qrlStockCode.Caption := 'Stock Deleted';
      if  dmDatabase.tblMessage.Locate('WMessageID', dmDatabase.qrPrnDocLinesWStockID.Value, []) then
        qrlStockCode.Caption := dmDatabase.tblMessageSDescription.Value;
    end;
