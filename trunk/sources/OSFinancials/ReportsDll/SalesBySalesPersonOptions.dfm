object fmSalesBySalesPersonOptions: TfmSalesBySalesPersonOptions
  Left = 275
  Top = 157
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Sales By Salesperson Options'
  ClientHeight = 217
  ClientWidth = 417
  Color = clBtnFace
