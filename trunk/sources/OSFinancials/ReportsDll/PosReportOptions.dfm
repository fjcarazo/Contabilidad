object fmPosReportOptions: TfmPosReportOptions
  ...
  object Panel1: TPanel
    ...
    object GBOptions: TGroupBox
      ...
      Caption = 'Options'
      TabOrder = 0
      object cbEatchSalesPersonSeperate: TCheckBox
        Left = 10
        Top = 15
        Width = 163
        Height = 17
        Caption = 'Each SalesPerson Separetly'
        TabOrder = 0
      end
      object CBShowInvoice: TCheckBox
        Left = 10
        Top = 35
        Width = 133
        Height = 17
        Caption = 'Show Invoice Number'
        TabOrder = 1
      end
      object CBShowAllSalespersons: TCheckBox
        Left = 10
        Top = 55
        Width = 179
        Height = 17
        Caption = 'Show All Salespersons'
        TabOrder = 2
      end
    end
