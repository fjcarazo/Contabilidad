...
type
  TqrUserReport = class(TQuickRep)
    ...
    procedure qrDescriptionPrint(sender: TObject; var Value: String);
...
begin
  Value:=AddDashInAccCodeNoPRefix(DmDatabase.tblAccountSACCOUNTCODE.Text);
end;

procedure TqrUserReport.qrDescriptionPrint(sender: TObject;
  var Value: String);
begin
  Value:=DmDatabase.tblAccountSDescription.Text;
end;
