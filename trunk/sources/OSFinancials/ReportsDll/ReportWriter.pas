...
uses
  ...
  clipbrd,ImgList, ComCtrls, ToolWin, Wwdatsrc, wwdbdatetimepicker, Wwdbdlg;
...
Begin
  ...
  0:With DmDatabase do
    begin
      ...
      dmDatabase.tblType.SQL.Text := 'select * from TYPES where WTypeParent = 7 order by WTypeID';
...
*)
  dmDatabase.tblRepLine.Edit;
  //dmDatabase.tblType.Open;
  dmDatabase.tblType.SQL.Text := 'select * from TYPES where WTypeParent = 8 order by WTypeID';
  dmDatabase.tblType.Open;
