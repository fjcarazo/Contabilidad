object fmCreditorListingOptions: TfmCreditorListingOptions
  Left = 256
  Top = 174
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Creditor Listing Options'
  ClientHeight = 195
  ClientWidth = 419
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object dbcomboxSequence: TDBComboBox
      ...
      DataField = 'SCreditorListingSequence'
    ...
    object dbedtFromAccount: TDBEdit
      ...
      Height = 21
      TabStop = False
      DataField = 'SCredListingFromAccount'
      DataSource = dmDatabase.dsReportingOptions
      TabOrder = 1
      OnKeyDown = FormKeyDown
      OnKeyPress = FormKeyPress
    ...
    object dbedtToAccount: TDBEdit
      ...
      Height = 21
      TabStop = False
      DataField = 'SCredListingToAccount'
      DataSource = dmDatabase.dsReportingOptions
      TabOrder = 3
      OnKeyDown = FormKeyDown
      OnKeyPress = FormKeyPress
    end
    object dbcboxShowDetail: TDBCheckBox
      Left = 24
      Top = 63
      Width = 184
      Height = 17
      ...
      Caption = 'Show Detail'
      DataField = 'BDebtorListingShowDetail'
      DataSource = dmDatabase.dsReportingOptions
      TabOrder = 5
      ValueChecked = '1'
      ValueUnchecked = '0'
