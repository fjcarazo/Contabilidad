object fmSalesPersonByProductOptions: TfmSalesPersonByProductOptions
  Left = 244
  Top = 174
  Width = 476
  Height = 261
  Caption = 'Salesperson By Product Options'
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object dbedtFromProduct: TDBEdit
      ...
      Height = 21
      TabStop = False
      DataField = 'SSalesPersByProdFromProd'
    ...
    object dbedtToProduct: TDBEdit
      ...
      Height = 21
      TabStop = False
      DataField = 'SSalesPersByProdToProd'
      DataSource = dmDatabase.dsReportingOptions
      TabOrder = 4
      OnKeyPress = FormKeyPress
    end
    object dbdtFromDate: TwwDBDateTimePicker
      ...
      DataField = 'DSalesPersByProdFromDate'
      DataSource = dmDatabase.dsReportingOptions
      Epoch = 1950
      ShowButton = True
      TabOrder = 6
    ...
    object dbdtToDate: TwwDBDateTimePicker
      ...
      CalendarAttributes.Font.Name = 'MS Sans Serif'
      CalendarAttributes.Font.Style = []
      DataField = 'DSalesPersByProdToDate'
      DataSource = dmDatabase.dsReportingOptions
      Epoch = 1950
      ShowButton = True
      TabOrder = 7
    ...
    object dbcomboxSequence: TDBComboBox
      ...
      Width = 185
      Height = 21
      DataField = 'SSalesPersByProdSequence'
      DataSource = dmDatabase.dsReportingOptions
      ItemHeight = 13
      TabOrder = 0
      OnKeyPress = FormKeyPress
