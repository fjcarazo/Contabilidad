object fmProductByCustomerOptions: TfmProductByCustomerOptions
  Left = 257
  Top = 186
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Product By Customer Options'
  ClientHeight = 248
  ClientWidth = 447
  Color = clBtnFace
