...
*)
unit BalanceReportOptions;

interface

uses
  Windows, Messages, SysUtils, Classes, Graphics, Controls, Forms, Dialogs,
  StdCtrls, DBCtrls, ExtCtrls, Buttons, ComCtrls,UReportBasis;
...
uses OsfLookup, HTMLHelpAPI , UDMTCCoreLink, UDMReportsGlobals, UMsgBox, Math ,shellapi;
{$R *.DFM}
...
Hide ;
 ...
 try
  ...
  Params := Params + 'STARTPERIODLASTYEAR=' + IntToStr(FromID-13) +#13 ;
  Params := Params + 'ENDPERIODLASTYEAR=' + IntToStr(ToID-13) +#13 ;
  ...
  0 : DMReportsGlobals.ShowReport('REPORTS\GL\BALANCE\GROUP1',Caption,params,ShowType,FileName) ;
  1 : DMReportsGlobals.ShowReport('REPORTS\GL\BALANCE\GROUP2',Caption,params,ShowType,FileName) ;
  end;
  if ShowType = 3 then
...
Procedure TfmBalanceSheetOptions.LoadReportOp;
begin
...
Procedure TfmBalanceSheetOptions.SaveReportOp;
begin
