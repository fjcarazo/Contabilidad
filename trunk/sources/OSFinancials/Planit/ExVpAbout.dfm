object frmAbout: TfrmAbout
  ...
  object VisitUsLabel: TLabel
    ...
    Width = 201
    Height = 13
    Caption = 'Visit TurboPower on the World Wide Web:'
  end
  object GeneralNewsgroupsLabel: TLabel
    ...
    Width = 196
    Height = 13
    Caption = 'TurboPower Online Support Newsgroups:'
  end
  ...
  object lblNewsGeneral: TLabel
    ...
    Height = 13
    Cursor = crHandPoint
    Caption = 'news://news.turbopower.com'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clHighlight
    Font.Height = -11
    Font.Name = 'MS Sans Serif'
  ...
  object SpecificNewsgroupLabel: TLabel
    Left = 160
    Top = 217
    Width = 197
    Height = 13
    Caption = 'Support for this product in the newsgroup:'
  end
  object lblNewsSpecific: TLabel
    Left = 174
    Top = 233
    Width = 180
    Height = 13
    Cursor = crHandPoint
    Caption = 'turbopower.public.support.VisualPlanIt'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clHighlight
    Font.Height = -11
    Font.Name = 'MS Sans Serif'
    Font.Style = []
    ParentFont = False
    OnClick = lblNewsSpecificClick
    OnMouseMove = lblTurboLinkMouseMove
  end
  object StayUpToDateLabel: TLabel
    Left = 153
    Top = 99
    Width = 205
    Height = 13
    Caption = 'Stay up to date with patches to this product'
  end
  object InTheLabel: TLabel
    Left = 161
    Top = 114
    Width = 26
    Height = 13
  ...
  object CopyrightLabel: TLabel
    ...
    Width = 242
    Height = 13
    Caption = 'Copyright '#169' 2002, TurboPower Software Company.'
  end
  ...
  object SignUpLabel: TLabel
    ...
    Width = 192
    Height = 13
    Caption = 'Sign-up for Online Electronic Newsletters'
  end
  object ForThisProductLabel: TLabel
    Left = 161
    Top = 154
    Width = 82
    Height = 13
    Caption = 'for this product at'
  end
  object lblFreeUpdateCenter: TLabel
    Left = 192
    Top = 114
    Width = 93
    Height = 13
    Cursor = crHandPoint
    Caption = 'Free Update Center'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clHighlight
    Font.Height = -11
    Font.Name = 'MS Sans Serif'
    Font.Style = []
    ParentFont = False
    OnClick = lblFreeUpdateCenterClick
    OnMouseMove = lblTurboLinkMouseMove
  end
  object lblTurboPowerLive: TLabel
    Left = 247
    Top = 154
    Width = 87
    Height = 13
    Cursor = crHandPoint
    Caption = 'TurboPower LIVE!'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clHighlight
    Font.Height = -11
    Font.Name = 'MS Sans Serif'
    Font.Style = []
    ParentFont = False
    OnClick = lblTurboPowerLiveClick
    OnMouseMove = lblTurboLinkMouseMove
  end
