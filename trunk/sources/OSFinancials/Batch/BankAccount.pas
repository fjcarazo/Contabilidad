...
begin
  ...
  begin
    ...
    begin
      ...
      with dmDatabase do
      begin
        tblAccount.filter :='WAccountTypeID=3 or WAccountTypeID=4 or WAccountTypeID=0'  ;
        ...
        begin
            if tblAccountWACCOUNTTYPEID.AsInteger <> 3 then
              begin
...
Disable(edtSubAccount);
  ...
  if not ReadReportOp('CBViewAllBankState',false).AsBoolean then
    begin
