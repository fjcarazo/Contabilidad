object fmEditReceipts: TfmEditReceipts
  Left = 264
  Top = 268
  BorderIcons = [biSystemMenu]
  Caption = 'fmEditReceipts'
  ClientHeight = 244
  ClientWidth = 519
  Color = clBtnFace
  ...
  object Panel2: TPanel
    ...
    object lblReceiptNo: TLabel
      Left = 108
      Top = 92
      Width = 61
      Height = 13
      Caption = 'lblReceiptNo'
    end
