object fmInvoicedDetailOptions: TfmInvoicedDetailOptions
  Left = 246
  Top = 128
  ...
  object Panel1: TPanel
    ...
    object dbcomboxWhichYear: TDBComboBox
      ...
      Width = 129
      Height = 21
      DataField = 'SInvoiceDetailWhichYear'
    ...
    object dbcbShowDetails: TDBCheckBox
      Left = 241
      Top = 73
      Width = 152
      Height = 17
      ...
      Caption = 'Show Detail'
      DataField = 'BInvoiceDetailShowDetail'
      DataSource = dmDatabase.dsReportingOptions
      TabOrder = 7
      ValueChecked = '1'
      ValueUnchecked = '0'
