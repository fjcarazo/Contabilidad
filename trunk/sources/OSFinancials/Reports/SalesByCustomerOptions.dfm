object fmSalesByCustomerOptions: TfmSalesByCustomerOptions
  Left = 277
  Top = 157
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Sales By Customer Options'
  ClientHeight = 200
  ClientWidth = 448
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object dbcomboxSequence: TDBComboBox
      ...
      Width = 137
      Height = 21
      DataField = 'SSalesByCustSequence'
    ...
    object dbedtFromCustomer: TDBEdit
      ...
      Height = 21
      TabStop = False
      DataField = 'SSalesByCustFromCust'
      DataSource = dmDatabase.dsReportingOptions
      TabOrder = 2
      OnKeyPress = FormKeyPress
    end
    ...
    object dbdtFromDate: TwwDBDateTimePicker
      ...
      DataField = 'DSalesByCustFromDate'
      DataSource = dmDatabase.dsReportingOptions
      Epoch = 1950
