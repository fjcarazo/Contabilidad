object fmSalesByProductOptions: TfmSalesByProductOptions
  Left = 301
  Top = 180
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Sales By Product Options'
  ClientHeight = 232
  ClientWidth = 423
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object dbedtFromProduct: TDBEdit
      ...
      Height = 21
      TabStop = False
      DataField = 'SSalesByProdFromProd'
    ...
    object dbdtFromDate: TwwDBDateTimePicker
      ...
      DataField = 'DSalesByProdFromDate'
      DataSource = dmDatabase.dsReportingOptions
      Epoch = 1950
      ShowButton = True
      TabOrder = 6
    ...
    object dbcomboxSequence: TDBComboBox
      ...
      DataField = 'SSalesByProdSequence'
      DataSource = dmDatabase.dsReportingOptions
      ItemHeight = 13
      TabOrder = 0
      OnKeyPress = FormKeyPress
