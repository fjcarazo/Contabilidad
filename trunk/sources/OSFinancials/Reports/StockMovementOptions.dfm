object fmStockMovementOptions: TfmStockMovementOptions
  Left = 278
  Top = 164
  Width = 466
  Height = 276
  BorderIcons = [biSystemMenu]
  Caption = 'Stock Movement Options'
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object dbcomboxSequence: TDBComboBox
      ...
      DataField = 'SStockMovementSequence'
      DataSource = dmDatabase.dsReportingOptions
      ItemHeight = 13
      TabOrder = 0
      OnKeyPress = FormKeyPress
    end
    object dbedtFromCode: TDBEdit
      Left = 122
      Top = 32
      Width = 143
      Height = 21
      TabStop = False
      DataField = 'SStockMovementFromCode'
      DataSource = dmDatabase.dsReportingOptions
      TabOrder = 1
      OnKeyPress = FormKeyPress
    end
    object dbedtToCode: TDBEdit
      Left = 121
      Top = 56
      Width = 144
      Height = 21
      TabStop = False
      DataField = 'SStockMovementToCode'
      DataSource = dmDatabase.dsReportingOptions
      TabOrder = 3
      OnKeyPress = FormKeyPress
    end
    object dbdtFromDate: TwwDBDateTimePicker
      ...
      DataField = 'DStockMovementFromDate'
      DataSource = dmDatabase.dsReportingOptions
      Epoch = 1950
    ...
    object dbdtToDate: TwwDBDateTimePicker
      ...
      CalendarAttributes.Font.Name = 'MS Sans Serif'
      CalendarAttributes.Font.Style = []
      DataField = 'DStockMovementToDate'
      DataSource = dmDatabase.dsReportingOptions
      Epoch = 1950
      MaxDate = 219148.000000000000000000
      MinDate = 2.000000000000000000
