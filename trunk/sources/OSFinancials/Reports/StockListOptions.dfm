object fmStockListOptions: TfmStockListOptions
  Left = 105
  Top = 78
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Stock List Options'
  ClientHeight = 337
  ClientWidth = 382
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object GroupBox1: TGroupBox
      ...
      TabOrder = 5
      object dbcboxSellingPrice: TLabel
        Left = 168
        Top = 22
        Width = 58
        Height = 13
      ...
      object cboxQtyOnHand: TCheckBox
        Left = 209
        Top = 44
        Width = 133
        Height = 13
        ...
        TabOrder = 5
        OnKeyPress = cboxQtyOnHandKeyPress
      end
      object dbcboxCostPrice: TCheckBox
        Left = 10
        Top = 83
        Width = 121
        Height = 13
      ...
      object cbcxSellingPrice: TComboBox
        Left = 235
        Top = 16
        Width = 107
        Height = 21
        ...
        ItemHeight = 13
        TabOrder = 3
        OnChange = cbcxSellingPriceChange
        OnKeyPress = cboxQtyOnHandKeyPress
      end
      object dbcboxStockCount: TCheckBox
        Left = 10
        Top = 19
        Width = 121
        Height = 15
      ...
      object dbcboxStockListAveCost: TCheckBox
        Left = 10
        Top = 40
        Width = 121
        Height = 15
      ...
      object dbcboxStockValue: TCheckBox
        Left = 10
        Top = 62
        Width = 121
        Height = 15
      ...
      object DBcbNilBal: TCheckBox
        Left = 209
        Top = 63
        Width = 133
        Height = 15
        Alignment = taLeftJustify
        Caption = 'Nil Balances'
        TabOrder = 6
        OnKeyPress = cboxQtyOnHandKeyPress
      end
      object CBInclusiveprice: TCheckBox
        Left = 209
        Top = 82
        Width = 133
        Height = 15
        Alignment = taLeftJustify
        Caption = 'Inclusive price'
        TabOrder = 7
        OnKeyPress = cboxQtyOnHandKeyPress
      end
      object CBShowZerostockCount: TCheckBox
        Left = 209
        Top = 100
        Width = 133
        Height = 15
        Alignment = taLeftJustify
        Caption = 'Show zero stock count'
        TabOrder = 8
        OnKeyPress = cboxQtyOnHandKeyPress
      end
    end
