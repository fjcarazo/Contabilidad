object frmSelectAccountType: TfrmSelectAccountType
  Left = 487
  Top = 198
  BorderIcons = []
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object LstAccountView: TcxListView
    Left = 0
    Top = 0
    Width = 169
    Height = 178
    ...
    TabOrder = 0
    ViewStyle = vsReport
    OnCustomDrawItem = LstAccountViewCustomDrawItem
    OnDblClick = LstAccountViewDblClick
    OnKeyPress = LstAccountViewKeyPress
    OnSelectItem = LstAccountViewSelectItem
    ExplicitHeight = 250
  end
