object fmInvocePayment: TfmInvocePayment
  Left = 176
  Top = 68
  Caption = 'Payment'
  ClientHeight = 512
  ...
  object LTotal: TLabel
    ...
    Font.Style = []
    ParentFont = False
    OnDblClick = LTotalDblClick
  end
  object LTotalEntered: TLabel
    Left = 88
    Top = 32
    Width = 118
    Height = 24
    Alignment = taRightJustify
    Caption = 'LTotalEntered'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -19
    Font.Name = 'MS Sans Serif'
    Font.Style = []
    ParentFont = False
    OnDblClick = LTotalEnteredDblClick
  end
  object LLTotal: TLabel
    Left = 4
    Top = 4
    Width = 51
    Height = 24
  ...
  object ZQGetPaymentTypes: TUniQuery
    DataTypeMap = <>
    SQL.Strings = (
