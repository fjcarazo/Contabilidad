...
function HtmlHelpShowContentID(ContextId: Longword): HWND;
...
function HtmlHelpShowHelp : HWND;
begin
   Result:=HtmlHelp(0, PChar(HelpFileName), HH_DISPLAY_TOPIC, 0);
end;

function HtmlHelpShowTopic(const aTopic : String) : HWND;
begin
   Result:=HtmlHelp(0, PChar(HelpFileName+'::/'+aTopic), HH_DISPLAY_TOPIC, 0);
end;

function HtmlHelpShowContents : HWND;
begin
   Result:=HtmlHelp(0, PChar(HelpFileName), HH_DISPLAY_TOC, 0);
end;

function HtmlHelpShowIndex : HWND;
begin
   Result:=HtmlHelp(0, PChar(HelpFileName), HH_DISPLAY_INDEX, 0);
end;

function HtmlHelpShowContentID(ContextId: Longword): HWND;
begin
  HtmlHelpShowContents;
  Result := HtmlHelp(0, PChar(HelpFileName), HH_HELP_CONTEXT, ContextId);
end;
