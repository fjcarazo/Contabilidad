               ...
               case Sp^ of
                 'a': begin
                      ...
                      begin
                        ...
                        if AnsiStrPos(Sp, 'apos;') = Sp then  { do not localize }
                      begin
                        Inc(Sp, 4);
                        Rp^ := '''';
                      end;
                 ...
                 '#': begin
                   ...
                   begin
                     Rp^ := Sp^;
                   //raise EConvertError.CreateFmt('Char %s is not valide.',
                   //  [Cp^ + Sp^, Cp - PChar(AStr)])
                   end;
               end;
           end
