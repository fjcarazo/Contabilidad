object FormMainConversion: TFormMainConversion
  ...
  object PCConversion: TPageControl
    ...
    object TsStart: TTabSheet
      ...
      object Label3: TLabel
        ...
        Width = 114
        Height = 13
        Caption = 'Your Turbocash 3 folder'
      end
      ...
      object BNext: TButton
        ...
        Width = 297
        Height = 25
        Caption = 'Scan for books in TC 3'
        Default = True
        TabOrder = 1
        OnClick = BNextClick
      end
      object MemohelpFindFile: TMemo
        ...
        Color = clScrollBar
        Lines.Strings = (
          'Select Your old folder of TCash '
          '3.7.4.97+'
          '')
        TabOrder = 2
      end
      ...
      object cbDoTranslations: TCheckBox
        Left = 112
        Top = 88
        Width = 153
        Height = 17
        Caption = 'Convert translations'
        TabOrder = 5
      end
    end
  ...
  object Query1: TQuery
    ...
    SQL.Strings = (
      ...
      'and Account.WReportingGroup2Id = group2.WGroupID '
        ...
        'and WAccountTypeId not in (1,2) and (WPEriodId > 13 or WPeriodId' +
        ' =0) and BActual = true'
        ...
        't.SDescription,WAccountTypeID,BIncomeExpense,'
      'Group1.WSortNo,'
  ...
  object ZConnection1: TUniConnection
    ...
    Database = 'C:\Turbocash\Books\CONXP\books.FDB'
    Password = 'masterkey'
    Left = 416
    Top = 376
  end
  ...
  object ZUSQLToLogo: TUniUpdateSQL
    ...
    DeleteSQL.Strings = (
      ...
      'WHERE'
        ...
        '  ((SYSVARS.SCOMPANYNAME IS NULL AND :OLD_SCOMPANYNAME IS NULL) ' +
        'OR (SYSVARS.SCOMPANYNAME = :OLD_SCOMPANYNAME))')
    ModifySQL.Strings = (
      'UPDATE SYSVARS SET'
  ...
  object QFromLogo: TQuery
    DatabaseName = 'a'
    SQL.Strings = (
      'select * from sysvars')
    Left = 228
    Top = 264
    object QFromLogoSCompanyName: TStringField
      FieldName = 'SCompanyName'
      Size = 35
    end
    object QFromLogoSCompanyRegNo: TStringField
      FieldName = 'SCompanyRegNo'
      Size = 30
    end
    object QFromLogoWEmailServerAddress: TStringField
      FieldName = 'WEmailServerAddress'
      Size = 30
    end
    object QFromLogoWFaxServerID: TIntegerField
      FieldName = 'WFaxServerID'
    end
    object QFromLogoBlobLogo: TGraphicField
      FieldName = 'BlobLogo'
      BlobType = ftGraphic
    end
    object QFromLogoSAddress1: TStringField
      FieldName = 'SAddress1'
      Size = 30
    end
    object QFromLogoSAddress2: TStringField
      FieldName = 'SAddress2'
      Size = 30
    end
    object QFromLogoSAddress3: TStringField
      FieldName = 'SAddress3'
      Size = 30
    end
    object QFromLogoSPostCode: TStringField
      FieldName = 'SPostCode'
      Size = 8
    end
    object QFromLogoSPhoneNumber: TStringField
      FieldName = 'SPhoneNumber'
      Size = 30
    end
    object QFromLogoSFaxNumber: TStringField
      FieldName = 'SFaxNumber'
      Size = 30
    end
    object QFromLogoWRetainedIncomeID: TIntegerField
      FieldName = 'WRetainedIncomeID'
    end
    object QFromLogoWDebtorsControlID: TIntegerField
      FieldName = 'WDebtorsControlID'
    end
    object QFromLogoWCreditorsControlID: TIntegerField
      FieldName = 'WCreditorsControlID'
    end
    object QFromLogoSBackupPath: TStringField
      FieldName = 'SBackupPath'
      Size = 255
    end
    object QFromLogoWCostOfSalesTypeID: TIntegerField
      FieldName = 'WCostOfSalesTypeID'
    end
    object QFromLogoWCreditNoteBatchTypeID: TIntegerField
      FieldName = 'WCreditNoteBatchTypeID'
    end
    object QFromLogoSCreditNoteMessage1: TStringField
      FieldName = 'SCreditNoteMessage1'
      Size = 30
    end
    object QFromLogoSCreditNoteMessage2: TStringField
      FieldName = 'SCreditNoteMessage2'
      Size = 30
    end
    object QFromLogoSCreditNoteMessage3: TStringField
      FieldName = 'SCreditNoteMessage3'
      Size = 30
    end
    object QFromLogoWPurchasesBatchID: TIntegerField
      FieldName = 'WPurchasesBatchID'
    end
    object QFromLogoSPurchasesMessage1: TStringField
      FieldName = 'SPurchasesMessage1'
      Size = 30
    end
    object QFromLogoSPurchasesMessage2: TStringField
      FieldName = 'SPurchasesMessage2'
      Size = 30
    end
    object QFromLogoSPurchasesMessage3: TStringField
      FieldName = 'SPurchasesMessage3'
      Size = 30
    end
    object QFromLogoWGoodsReturnedBatchID: TIntegerField
      FieldName = 'WGoodsReturnedBatchID'
    end
    object QFromLogoSGoodsReturnedMessage1: TStringField
      FieldName = 'SGoodsReturnedMessage1'
      Size = 30
    end
    object QFromLogoSGoodsReturnedMessage2: TStringField
      FieldName = 'SGoodsReturnedMessage2'
      Size = 30
    end
    object QFromLogoSGoodsReturnedMessage3: TStringField
      FieldName = 'SGoodsReturnedMessage3'
      Size = 30
    end
    object QFromLogoWInvoicesBatchID: TIntegerField
      FieldName = 'WInvoicesBatchID'
    end
    object QFromLogoSInvoicesMessage1: TStringField
      FieldName = 'SInvoicesMessage1'
      Size = 30
    end
    object QFromLogoSInvoicesMessage2: TStringField
      FieldName = 'SInvoicesMessage2'
      Size = 30
    end
    object QFromLogoSInvoicesMessage3: TStringField
      FieldName = 'SInvoicesMessage3'
      Size = 30
    end
    object QFromLogoWDisplayAmount: TIntegerField
      FieldName = 'WDisplayAmount'
    end
    object QFromLogoBAccountsOpen: TBooleanField
      FieldName = 'BAccountsOpen'
    end
    object QFromLogoBBatchTypes: TBooleanField
      FieldName = 'BBatchTypes'
    end
    object QFromLogoBGroups: TBooleanField
      FieldName = 'BGroups'
    end
    object QFromLogoBNotClosed: TBooleanField
      FieldName = 'BNotClosed'
    end
    object QFromLogoBPeriodChange: TBooleanField
      FieldName = 'BPeriodChange'
    end
    object QFromLogoBSalesmanExist: TBooleanField
      FieldName = 'BSalesmanExist'
    end
    object QFromLogoBUnitsExist: TBooleanField
      FieldName = 'BUnitsExist'
    end
    object QFromLogoFLastYearPL: TFloatField
      FieldName = 'FLastYearPL'
    end
    object QFromLogoWNoOfPeriods: TIntegerField
      FieldName = 'WNoOfPeriods'
    end
    object QFromLogoWInvoicePaperID: TIntegerField
      FieldName = 'WInvoicePaperID'
    end
    object QFromLogoWCreditNotePaperID: TIntegerField
      FieldName = 'WCreditNotePaperID'
    end
    object QFromLogoWPurchasePaperID: TIntegerField
      FieldName = 'WPurchasePaperID'
    end
    object QFromLogoWGoodsReturnedPaperID: TIntegerField
      FieldName = 'WGoodsReturnedPaperID'
    end
    object QFromLogoWQuotePaperID: TIntegerField
      FieldName = 'WQuotePaperID'
    end
    object QFromLogoWOrderPaperID: TIntegerField
      FieldName = 'WOrderPaperID'
    end
    object QFromLogoWStatementPaperID: TIntegerField
      FieldName = 'WStatementPaperID'
    end
    object QFromLogoWRemittancePaperID: TIntegerField
      FieldName = 'WRemittancePaperID'
    end
    object QFromLogoFReconciledBankBalance: TFloatField
      FieldName = 'FReconciledBankBalance'
    end
    object QFromLogoWReconciledBankID: TIntegerField
      FieldName = 'WReconciledBankID'
    end
    object QFromLogoDReconciledLastDate: TDateField
      FieldName = 'DReconciledLastDate'
    end
    object QFromLogoSStatementMessage1: TStringField
      FieldName = 'SStatementMessage1'
      Size = 30
    end
    object QFromLogoSStatementMessage2: TStringField
      FieldName = 'SStatementMessage2'
      Size = 30
    end
    object QFromLogoSStatementMessage3: TStringField
      FieldName = 'SStatementMessage3'
      Size = 30
    end
    object QFromLogoBCreateBalanceLink: TBooleanField
      FieldName = 'BCreateBalanceLink'
    end
    object QFromLogoWTaxDueAccountID: TIntegerField
      FieldName = 'WTaxDueAccountID'
    end
    object QFromLogoBTaxInvoiceBased: TBooleanField
      FieldName = 'BTaxInvoiceBased'
    end
    object QFromLogoBCreateCostOfSales: TBooleanField
      FieldName = 'BCreateCostOfSales'
    end
    object QFromLogoWCurrentUserID: TIntegerField
      FieldName = 'WCurrentUserID'
    end
    object QFromLogoSInvoiceHeading: TStringField
      FieldName = 'SInvoiceHeading'
    end
    object QFromLogoSCreditNoteHeading: TStringField
      FieldName = 'SCreditNoteHeading'
    end
    object QFromLogoSPurchaseHeading: TStringField
      FieldName = 'SPurchaseHeading'
    end
    object QFromLogoSGoodsReturnedHeading: TStringField
      FieldName = 'SGoodsReturnedHeading'
    end
    object QFromLogoSQuoteHeading: TStringField
      FieldName = 'SQuoteHeading'
    end
    object QFromLogoSQuoteMessage1: TStringField
      FieldName = 'SQuoteMessage1'
      Size = 30
    end
    object QFromLogoSQuoteMessage2: TStringField
      FieldName = 'SQuoteMessage2'
      Size = 30
    end
    object QFromLogoSQuoteMessage3: TStringField
      FieldName = 'SQuoteMessage3'
      Size = 30
    end
    object QFromLogoSOrderHeading: TStringField
      FieldName = 'SOrderHeading'
    end
    object QFromLogoSOrderMessage1: TStringField
      FieldName = 'SOrderMessage1'
      Size = 30
    end
    object QFromLogoSOrderMessage2: TStringField
      FieldName = 'SOrderMessage2'
      Size = 30
    end
    object QFromLogoSOrderMessage3: TStringField
      FieldName = 'SOrderMessage3'
      Size = 30
    end
    object QFromLogoBPostToLastYear: TBooleanField
      FieldName = 'BPostToLastYear'
    end
    object QFromLogoWBaseCurrencyID: TIntegerField
      FieldName = 'WBaseCurrencyID'
    end
    object QFromLogoBMultiCurrency: TBooleanField
      FieldName = 'BMultiCurrency'
    end
    object QFromLogoSTaxRegNo: TStringField
      FieldName = 'STaxRegNo'
      Size = 30
    end
    object QFromLogoBPaymentsBased: TBooleanField
      FieldName = 'BPaymentsBased'
    end
    object QFromLogoWDueAccountID: TIntegerField
      FieldName = 'WDueAccountID'
    end
    object QFromLogoWLanguageID: TIntegerField
      FieldName = 'WLanguageID'
    end
    object QFromLogoBOnline: TBooleanField
      FieldName = 'BOnline'
    end
    object QFromLogoBRemote: TBooleanField
      FieldName = 'BRemote'
    end
    object QFromLogoWColourID: TIntegerField
      FieldName = 'WColourID'
    end
    object QFromLogoSAccountReportName1: TStringField
      FieldName = 'SAccountReportName1'
      Size = 15
    end
    object QFromLogoSAccountReportName2: TStringField
      FieldName = 'SAccountReportName2'
      Size = 15
    end
    object QFromLogoSDebtorReportName1: TStringField
      FieldName = 'SDebtorReportName1'
      Size = 15
    end
    object QFromLogoSDebtorReportName2: TStringField
      FieldName = 'SDebtorReportName2'
      Size = 15
    end
    object QFromLogoSCreditorReportName1: TStringField
      FieldName = 'SCreditorReportName1'
      Size = 15
    end
    object QFromLogoSCreditorReportName2: TStringField
      FieldName = 'SCreditorReportName2'
      Size = 15
    end
    object QFromLogoSStockReportName1: TStringField
      FieldName = 'SStockReportName1'
      Size = 15
    end
    object QFromLogoSStockReportName2: TStringField
      FieldName = 'SStockReportName2'
      Size = 15
    end
    object QFromLogoSDocumentReportName1: TStringField
      FieldName = 'SDocumentReportName1'
      Size = 15
    end
    object QFromLogoSDocumentReportName2: TStringField
      FieldName = 'SDocumentReportName2'
      Size = 15
    end
    object QFromLogoSSellingPriceName1: TStringField
      FieldName = 'SSellingPriceName1'
      Size = 15
    end
    object QFromLogoSSellingPriceName2: TStringField
      FieldName = 'SSellingPriceName2'
      Size = 15
    end
    object QFromLogoSSellingPriceName3: TStringField
      FieldName = 'SSellingPriceName3'
      Size = 15
    end
    object QFromLogoWVersion: TIntegerField
      FieldName = 'WVersion'
    end
    object QFromLogoSReportFontsName: TStringField
      FieldName = 'SReportFontsName'
      Size = 35
    end
    object QFromLogoBUseAvgCost: TBooleanField
      FieldName = 'BUseAvgCost'
    end
    object QFromLogoBPrnStatementLogo: TBooleanField
      FieldName = 'BPrnStatementLogo'
    end
    object QFromLogoDTLastUseTime: TDateTimeField
      FieldName = 'DTLastUseTime'
    end
    object QFromLogoBShowTips: TBooleanField
      FieldName = 'BShowTips'
    end
    object QFromLogoWAutoSaveTime: TIntegerField
      FieldName = 'WAutoSaveTime'
    end
    object QFromLogoBShowReminder: TBooleanField
      FieldName = 'BShowReminder'
    end
    object QFromLogoBServicePreprinted: TBooleanField
      FieldName = 'BServicePreprinted'
    end
    object QFromLogoWDefaultOutPutID: TIntegerField
      FieldName = 'WDefaultOutPutID'
    end
    object QFromLogoWDefaultZoom: TIntegerField
      FieldName = 'WDefaultZoom'
    end
    object QFromLogoBUseOutLookExp: TBooleanField
      FieldName = 'BUseOutLookExp'
    end
    object QFromLogoSEmailAddress: TStringField
      FieldName = 'SEmailAddress'
      Size = 60
    end
  end
  ...
  object ZSQLPrUpdateTables: TUniScript
    SQL.Strings = (
      ...
      'references ACCOUNT (WACCOUNTID);'
      '')
    OnError = ZSQLPrUpdateTablesError
    AutoCommit = True
    Connection = ZConnection1
    Left = 628
    Top = 320
