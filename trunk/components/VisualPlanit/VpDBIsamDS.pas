      ...
      for I := pred(Resources.Count) downto 0 do begin
        ...
        if Resource.Deleted then begin
          ...
          then begin
            ...
            Qry.ParamByName('ResActive').AsInteger := Resource.Active;
        ...
        if Event.Deleted then begin
          ...
          then begin
            ...
            try
              ...
              Qry.FieldByName('AllDayEvent').AsInteger := Event.AllDayEvent;
              Qry.FieldByName('AlarmSet').AsInteger := Event.AlarmSet;
