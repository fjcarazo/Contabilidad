// Modified by Delphidreamer 2007 for osFinancials.
...
uses
  ...
  VpBase, VpBaseDS, VpMisc, VpData, VpSR, VpConst, VpCanvasUtils, Menus,VpSRVars;
...
uses
  SysUtils, Math, Forms, Dialogs, VpEvntEditDlg, DateUtils;
  ...
  begin
   ...
   // done : Pieter Valentijn
                ...
                if col = 0 then
                 begin
                    TPSTextOut (RenderCanvas, Angle, RenderIn,
                                TextRect.Left + TextMargin, TextRect.Top + mvRowHeight - (-RenderCanvas.Font.Height + TextMargin),
                                  IntToStr(WeekOf(ThisDate)));
                  end;
               // End done                              
                { Update Array }
                mvMonthDayArray[I].Rec := TextRect;
