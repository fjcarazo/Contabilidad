        ...
        if Resource.Deleted then begin
          ...
          then begin
            ...
            try
              ...
              Qry.FieldByName('ResourceActive').AsInteger := ord(Resource.Active);
            ...
            Qry.ParamByName('ResActive').AsInteger := ord(Resource.Active);
        ...
        if Event.Deleted then begin
          ...
          then begin
            ...
            try
              ...
              Qry.FieldByName('AllDayEvent').AsInteger := ord(Event.AllDayEvent);
              Qry.FieldByName('AlarmSet').AsInteger := ord(Event.AlarmSet);
            ...
            Qry.ParamByName('ADEvent').AsInteger      := ord(Event.AllDayEvent);
            Qry.ParamByName('ASet').AsInteger         := ord(Event.AlarmSet);
        ...
        if Task.Deleted then begin
          ...
          then begin
            ...
            try
              ...
              Qry.FieldByName('Complete').AsInteger := ord(Task.Complete);
            ...
            Qry.ParamByName('Complete').AsInteger     := ord(Task.Complete);
