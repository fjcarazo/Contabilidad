      ...
      for I := pred(Resource.Schedule.EventCount) downto 0 do begin
        ...
        if Event.Deleted then begin
          ...
          then begin
            ...
            Qry.ParamByName('ADEvent').AsInteger      := Event.AllDayEvent;
            Qry.ParamByName('ASet').AsInteger         := Event.AlarmSet;
        ...
        if Task.Deleted then begin
          ...
          then begin
            ...
            try
              ...
              Qry.FieldByName('Complete').AsInteger := Task.Complete;
            ...
            Qry.ParamByName('Complete').AsInteger     := Task.Complete;
