...
{$ENDIF}
     if (FSSL) then
     begin
      connect.IOHandler:=TIdSSLIOHandlerSocketOpenSSL.Create(nil);
      TIdSSLIOHandlerSocketOpenSSL(connect.IOHandler).SSLOptions.Mode:= sslmClient;
      TIdSSLIOHandlerSocketOpenSSL(connect.IOHandler).SSLOptions.Method:=sslvSSLv23;
     end;
