...
begin
 ...
 begin
    if Assigned(fobjinsp) then
      TFRpObjInspVCL(fobjinsp).AUndoList.Add(fprintitem.Name+'=WIDTH;' + FloatToStr(fprintitem. Width));
 ...
 begin
    if Assigned(fobjinsp) then
      TFRpObjInspVCL(fobjinsp).AUndoList.Add(fprintitem.Name+'=HEIGHT;' +FloatTostr(fprintitem.Height));
...
begin
 ...
 begin
  if Assigned(fobjinsp) then
      TFRpObjInspVCL(fobjinsp).AUndoList.Add(fprintitem.Name+'=LEFT;' + FloatToStr(TRpCommonPosComponent(fprintitem).PosX));
 ...
 begin
  if Assigned(fobjinsp) then
      TFRpObjInspVCL(fobjinsp).AUndoList.Add(fprintitem.Name+'=TOP;' + FloatToStr(TRpCommonPosComponent(fprintitem).PosY));
...
begin
 ...
 begin
  ...
  if Assigned(fobjinsp) then
     begin
      TFRpObjInspVCL(fobjinsp).AUndoList.Add(printitem.Name+'=LEFT;' + FloatToStr(TRpCommonPosComponent(printitem).PosX));
      TFRpObjInspVCL(fobjinsp).AUndoList.Add(printitem.Name+'=TOP;' + FloatToStr(TRpCommonPosComponent(printitem).PosY));
     end;
     aitem.PosX:=NewLeft;
     aitem.PosY:=NewTop;
     afitem.UpdatePos;
